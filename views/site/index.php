...
<div style="margin-top: 100px;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <?=
                Html::a('<i class="glyphicon   	glyphicon glyphicon-plus"></i><span class="count-name">New User</span>', ['/users/create'], [
            ...
            <div class="col-md-6">
                <?=
                Html::a('<i class= "glyphicon 	glyphicon glyphicon-edit "></i><span class="count-name">New Restaurant</span>', ['/restaurant/create'], [
            ...
            <div class="col-md-6">
                <?=
                Html::a('<i class="	glyphicon glyphicon-apple"></i><span class="count-name">New Food Category</span>', ['/food-category/create'], [

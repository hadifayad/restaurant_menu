	...
	'//www.googletagmanager.com/gtm.'+'js?id='+i+dl;f.parentNode.insertBefore(j,f);
			...
			<link rel="apple-touch-icon-precomposed" href="<?= "http://the-onlinemenu.com/restaurantsUploads/".$restuarant['icon']?>">
...
@font-face {
    font-family: 'molhimregular';
    src: url('../fonts/molhim-webfont.woff2') format('woff2'),
         url('../fonts/molhim-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal;
...
@font-face {
    ...
    src: url('../fonts/back_to_school-webfont.woff2') format('woff2'),
         url('../fonts/back_to_school-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal;
...
@font-face {
    font-family: 'molhimbold';
    src: url('../fonts/molhim_bold-webfont.woff2') format('woff2'),
         url('../fonts/molhim_bold-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal;
...
@font-face {
    font-family: '18_khebrat_musamimbold';
    src: url('../fonts/18_khebrat_musamim_bold-webfont.woff2') format('woff2'),
         url('../fonts/18_khebrat_musamim_bold-webfont.woff') format('woff');
    font-weight: normal;
    font-style: normal;
...
<meta http-equiv="Content-Type" content="text/html" charset=utf-8"/>
	...
	<div data-mkdf-parallax-speed="1" class="vc_row wpb_row vc_row-fluid mkdf-section vc_custom_1447685263059 mkdf-content-aligment-left" style="">
            <div class="clearfix mkdf-full-section-inner" style="direction: <?= $restuarant['direction']?>;">
                <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-12 vc_col-md-12" style="padding-left: 0px!important;  padding-right:0px!important;">
	...
	<p style ="text-align-last: start;   padding-right:  10px;padding-left: 10px;;"><?= $food[$j]['food'][$i]["description"] ?></p>
	</div>
	</div>
	</div>
	</li>
